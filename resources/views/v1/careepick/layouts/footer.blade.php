                                        ...
                                        <div class="row gx-3 gy-4">
                                            <div class="modal-login-form">
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-primary full-width font--bold btn-lg">Login</button>
                                                    </div>
                                                    <div class="modal-flex-item mb-3">
                                                        <div class="modal-flex-first">
                                                            <div class="form-check form-check-inline">
                        ...
                        <div class="vesh-detail-bloc">
                            <div class="vesh-detail-bloc-body pt-3">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="jobprovidersignup" role="tabpanel" aria-labelledby="job-provider-signup-tab" tabindex="0">
                                        <div class="row gx-3 gy-4">
                                            <div class="modal-login-form">
                                                <form>
