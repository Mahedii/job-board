                ...
                <div class="col-md-8 col-sm-7">
                    <div class="detail-wrapper">
                        <div class="detail-wrapper-body">
                            <div class="row">
                                <div class="col-md-4 text-center user_profile_img"> <img src="{{ URL::asset('assets/img/company_logo_1.png') }}"
                                        class="width-100" alt="" />
                                    <h4 class="meg-0">Web Designer</h4>
                                    <span>512 Big Tower, New Delhi</span>
                                    <div class="text-center">
                                        <button type="button" data-toggle="modal" data-target="#signin"
                                            class="btn-job theme-btn job-apply">Apply Now</button>
                                    </div>
                                </div>
                                <div class="col-md-8 user_job_detail">
                                    <div class="col-sm-12 mrg-bot-10"> <i class="ti-credit-card padd-r-10"></i>20K To
                                        50K/Month </div>
                                    <div class="col-sm-12 mrg-bot-10"> <i class="ti-mobile padd-r-10"></i>91 234 567 8765
                                    </div>
                                    <div class="col-sm-12 mrg-bot-10"> <i class="ti-email padd-r-10"></i>mail@example.com
                                    </div>
                                    <div class="col-sm-12 mrg-bot-10"> <i class="ti-calendar padd-r-10"></i><span
                                            class="full-type">Full Time</span> </div>
                                    <div class="col-sm-12 mrg-bot-10"> <i class="ti-user padd-r-10"></i><span
                                            class="cl-danger">7 Open Position</span> </div>
                    ...
                    <div class="detail-wrapper">
                        ...
                        <div class="detail-wrapper-body">
                            <ul class="detail-list">
                                ...
                                <li>looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage
                                    ideas </li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Full Time</span>
                        ...
                        <div class="u-content">
                            <div class="avatar box-80"> <a href="employer-detail.html"> <img class="img-responsive"
                                        src="{{ URL::asset('assets/img/company_logo_3.png') }}" alt=""> </a> </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
                        ...
                        <div class="u-content">
                            <div class="avatar box-80"> <a href="employer-detail.html"> <img class="img-responsive"
                                        src="{{ URL::asset('assets/img/company_logo_4.png') }}" alt=""> </a> </div>
