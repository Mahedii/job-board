        ...
        <div class="container">
            <div class="user_acount_info">
                <div class="col-md-3 col-sm-5">
                    <div class="emp-pic"> <img class="img-responsive width-270" src="{{ URL::asset('assets/img/user-profile.png') }}"
                            alt=""> </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
                        ...
                        <div class="u-content">
                            <div class="avatar box-80"> <a href="employer-detail.html"> <img class="img-responsive"
                                        src="{{ URL::asset('assets/img/company_logo_6.png') }}" alt=""> </a> </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
                        ...
                        <div class="u-content">
                            <div class="avatar box-80"> <a href="employer-detail.html"> <img class="img-responsive"
                                        src="{{ URL::asset('assets/img/company_logo_8.png') }}" alt=""> </a> </div>
                            <h5><a href="employer-detail.html">New Product Mockup</a></h5>
