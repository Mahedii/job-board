                                    ...
                                    <form method="POST" action="{{ route('jp-register.post') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="card card-h-100">
                                            <div class="card-header" style="border-bottom: none;">
                                                ...
                                                <input type="hidden" class="method_type" name="method_type" value="create">
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                ...
                                                <div class="row gx-3 gy-4">
                                                    ...
                                                    <div class="mb-4 col-md-4 col-sm-6 col-xs-12 m-clear">
                                                        ...
                                                        @if ($errors->has('company_district'))
                                                            <span class="text-danger">{{ $errors->first('company_district') }}</span>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="mb-4 col-md-4 col-sm-6 col-xs-12 m-clear">
                                                        ...
                                                        @if ($errors->has('company_upazila'))
                                                            <span class="text-danger">{{ $errors->first('company_upazila') }}</span>
                                                        @endif
                                                    </div>
